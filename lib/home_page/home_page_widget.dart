                ...
                return GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: PedidoUnicoIncluirWidget(),
                    ),
                  ),
                );
              },
                      ...
                      children: [
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        await listViewPedidoRecord.reference
                                            .delete();
                                      },
                                    ),
                                    Theme(
                                      ...
                                      child: Checkbox(
                                        value: _model.cKSelectValueMap[
                                            listViewPedidoRecord] ??= true,
                                        onChanged: (newValue) async {
                                          setState(() =>
                                              _model.cKSelectValueMap[
                                                      listViewPedidoRecord] =
                                                  newValue!);
                                        },
                                        activeColor:
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await actions.copiaTarefasAuto(
                                FFAppState().TarIPs.toList(),
                                FFAppState().servicoBaseIdVar!,
                              );
                            },
                            text: FFLocalizations.of(context).getText(
                              'zjo3x5cb' /* Cópia tarefas */,
                            ),
                            options: FFButtonOptions(
                              width: 130.0,
                              height: 40.0,
